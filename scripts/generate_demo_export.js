...
<ul>
  ...
  <li><strong>Recall Benchmark:</strong> Retrievability index calibrated to FSRS-6 algorithm.</li>
    ...
    topicsStore.push({
      ...
      subject: sub.subject,
      subdeck: sub.subject,
      path: `AutoAnki::NEET_PG_Vault::${sub.subject}::${t.name}`,
      cardCount: 15 + (idx * 3),
...
const rawCardsData = [
  // Anatomy
  { type: 'Cloze', text: 'Erb palsy results from injury to the {{c1::upper trunk (C5-C6)}} of the brachial plexus, presenting with the classic {{c2::waiter\'s tip}} deformity (adducted, internally rotated arm and pronated forearm).', deck: 'AutoAnki::NEET_PG_Vault::Anatomy', subject: 'Anatomy', tags: ['brachial-plexus', 'pyt-high-yield', 'nerve-injury'] },
  { type: 'Cloze', text: 'Klumpke palsy results from injury to the {{c1::lower trunk (C8-T1)}} of the brachial plexus, leading to {{c2::claw hand}} due to intrinsic hand muscle paralysis and concomitant {{c3::Horner syndrome}} if sympathetic fibers are involved.', deck: 'AutoAnki::NEET_PG_Vault::Anatomy', subject: 'Anatomy', tags: ['brachial-plexus', 'claw-hand', 'horner-syndrome'] },
  { type: 'Basic', front: 'Which structure passes through the foramen spinosum and what is its clinical significance?', back: '<strong>Middle Meningeal Artery</strong> (branch of maxillary artery).<br>Laceration by pterion fracture leads to an <strong>Epidural Hematoma (biconvex/lenticular shape on CT)</strong> with a classic <em>lucid interval</em>.', deck: 'AutoAnki::NEET_PG_Vault::Anatomy', subject: 'Anatomy', tags: ['skull-base', 'radiology', 'neurosurgery'] },
  { type: 'Basic', front: 'What are the boundaries and contents of the Femoral Ring?', back: '<strong>Boundaries:</strong><br>• Anterior: Inguinal ligament<br>• Medial: Lacunar ligament (Gimbernat)<br>• Lateral: Femoral vein septum<br>• Posterior: Pectineal ligament (Cooper)<br><strong>Content:</strong> Cloquet lymph node / fat. Site of Femoral Hernia.', deck: 'AutoAnki::NEET_PG_Vault::Anatomy', subject: 'Anatomy', tags: ['lower-limb', 'surgery-anatomy', 'hernia'] },
  { type: 'Cloze', text: 'The {{c1::Abducens nerve (CN VI)}} is the only cranial nerve that runs freely <em>inside</em> the cavernous sinus next to the {{c2::internal carotid artery}}, making it the earliest nerve affected in cavernous sinus thrombosis or ICA aneurysm.', deck: 'AutoAnki::NEET_PG_Vault::Anatomy', subject: 'Anatomy', tags: ['cranial-nerves', 'cavernous-sinus'] },
  { type: 'Basic', front: 'What are the derivatives of the 3rd and 4th Pharyngeal Pouches?', back: '• <strong>3rd Pouch:</strong> Inferior parathyroid glands + Thymus (mnemonic: 3 letters in SIT)<br>• <strong>4th Pouch:</strong> Superior parathyroid glands + Ultimobranchial body (Parafollicular C-cells of thyroid).', deck: 'AutoAnki::NEET_PG_Vault::Anatomy', subject: 'Anatomy', tags: ['embryology', 'pharyngeal-pouches'] },

  // Physiology
  { type: 'Cloze', text: 'Phase 0 of the ventricular cardiac action potential is caused by rapid {{c1::Na+ influx via fast voltage-gated Na+ channels}}, while Phase 2 (plateau) is sustained by {{c2::Ca2+ influx via L-type calcium channels}} balancing K+ efflux.', deck: 'AutoAnki::NEET_PG_Vault::Physiology', subject: 'Physiology', tags: ['cardiac-physiology', 'electrophysiology'] },
  { type: 'Basic', front: 'How does Inulin clearance differ from PAH clearance in renal physiology?', back: '• <strong>Inulin:</strong> Freely filtered, neither reabsorbed nor secreted -> used to calculate <strong>Glomerular Filtration Rate (GFR)</strong>.<br>• <strong>PAH (Para-aminohippuric acid):</strong> Freely filtered and actively secreted -> used to calculate <strong>Effective Renal Plasma Flow (eRPF)</strong>.', deck: 'AutoAnki::NEET_PG_Vault::Physiology', subject: 'Physiology', tags: ['renal-clearance', 'gfr'] },

  // Biochemistry
  { type: 'Cloze', text: 'Phenylketonuria (PKU) is caused by a deficiency of {{c1::Phenylalanine Hydroxylase (PAH)}} or its cofactor {{c2::Tetrahydrobiopterin (BH4)}}, leading to musty/mousy body odor and elevated phenylketones.', deck: 'AutoAnki::NEET_PG_Vault::Biochemistry', subject: 'Biochemistry', tags: ['inborn-errors', 'amino-acids'] },
  { type: 'Basic', front: 'What is the biochemical hallmark and clinical manifestation of Wernicke-Korsakoff Syndrome?', back: 'Deficiency of <strong>Thiamine (Vitamin B1)</strong>, which impairs pyruvate dehydrogenase and alpha-ketoglutarate dehydrogenase.<br><strong>Classic Triad:</strong> Encephalopathy + Oculomotor dysfunction (nystagmus, ophthalmoplegia) + Ataxia. Korsakoff adds confabulation and anterograde amnesia (mammillary body necrosis).', deck: 'AutoAnki::NEET_PG_Vault::Biochemistry', subject: 'Biochemistry', tags: ['vitamins', 'neurology'] },

  // Pharmacology
  { type: 'Cloze', text: 'The drug of choice for acute organophosphate poisoning is {{c1::Atropine}} (competitive muscarinic antagonist to reverse SLUDGE symptoms) combined with {{c2::Pralidoxime (2-PAM)}} to reactivate phosphorylated acetylcholinesterase before aging occurs.', deck: 'AutoAnki::NEET_PG_Vault::Pharmacology', subject: 'Pharmacology', tags: ['autonomic', 'antidotes', 'toxicology'] },
  { type: 'Basic', front: 'Why are ACE Inhibitors (e.g. Enalapril) contraindicated in Bilateral Renal Artery Stenosis?', back: 'ACE inhibitors inhibit Angiotensin II-mediated constriction of the <strong>efferent arteriole</strong>. In bilateral renal artery stenosis, GFR is highly dependent on efferent vasoconstriction; blocking this causes a precipitous drop in intraglomerular pressure and <strong>acute renal failure</strong>.', deck: 'AutoAnki::NEET_PG_Vault::Pharmacology', subject: 'Pharmacology', tags: ['cardiology', 'nephrology', 'mechanism'] },
  { type: 'Cloze', text: '{{c1::Adenosine}} is the drug of choice for terminating Paroxysmal Supraventricular Tachycardia (PSVT), acting on {{c2::A1 receptors}} to activate potassium channels and hyperpolarize the AV node. Its ultra-short half-life is < {{c3::10 seconds}}.', deck: 'AutoAnki::NEET_PG_Vault::Pharmacology', subject: 'Pharmacology', tags: ['cardiology', 'antiarrhythmic', 'high-yield'] },
  { type: 'Basic', front: 'Classify First-Line Anti-Tubercular Drugs (HRZE) with their hallmark adverse effects:', back: '<ul><li><strong>Isoniazid (H):</strong> Peripheral neuropathy (prevent with Pyridoxine/Vit B6), Hepatotoxicity, Sideroblastic anemia</li><li><strong>Rifampicin (R):</strong> Orange/red urine & secretions, CYP450 inducer, Hepatotoxicity</li><li><strong>Pyrazinamide (Z):</strong> Hyperuricemia (Gout), Hepatotoxicity (most hepatotoxic)</li><li><strong>Ethambutol (E):</strong> Optic neuritis (red-green color blindness), hyperuricemia</li></ul>', deck: 'AutoAnki::NEET_PG_Vault::Pharmacology', subject: 'Pharmacology', tags: ['infectious-disease', 'pulmonology', 'mnemonics'] },
  { type: 'Cloze', text: '{{c1::Sugammadex}} is a modified gamma-cyclodextrin that selectively binds and encapsulates {{c2::Rocuronium and Vecuronium}}, providing rapid reversal of neuromuscular blockade without cholinergic side effects.', deck: 'AutoAnki::NEET_PG_Vault::Pharmacology', subject: 'Pharmacology', tags: ['anesthesia', 'reversal-agents'] },

  // Pathology
  { type: 'Cloze', text: 'In Burkitt Lymphoma, the characteristic cytogenetic translocation is {{c1::t(8;14)}}, causing overexpression of the {{c2::c-MYC}} oncogene, producing a pathognomonic {{c3::starry sky appearance}} on histology.', deck: 'AutoAnki::NEET_PG_Vault::Pathology', subject: 'Pathology', tags: ['hematology', 'cytogenetics', 'histology'] },
  { type: 'Basic', front: 'Contrast the histopathologic findings of Crohn Disease vs Ulcerative Colitis:', back: '<table border="1" style="border-collapse:collapse;width:100%"><tr><th>Feature</th><th>Crohn Disease</th><th>Ulcerative Colitis</th></tr><tr><td>Location</td><td>Anywhere (terminal ileum most common), Skip lesions</td><td>Rectum extending proximally, continuous</td></tr><tr><td>Depth</td><td>Transmural (fistulae, creeping fat)</td><td>Mucosa and submucosa only</td></tr><tr><td>Granulomas</td><td>Non-caseating granulomas (50%)</td><td>Crypt abscesses, NO granulomas</td></tr><tr><td>Lead-pipe sign</td><td>Cobblestone mucosa, string sign of Kantor</td><td>Lead-pipe colon on barium</td></tr></table>', deck: 'AutoAnki::NEET_PG_Vault::Pathology', subject: 'Pathology', tags: ['gastroenterology', 'high-yield-table', 'biopsy'] },
  { type: 'Cloze', text: '{{c1::Reed-Sternberg cells}} (binucleated "owl-eye" appearance with prominent eosinophilic nucleoli) are diagnostic of {{c2::Hodgkin Lymphoma}} and typically express surface markers {{c3::CD15 and CD30}}.', deck: 'AutoAnki::NEET_PG_Vault::Pathology', subject: 'Pathology', tags: ['hematopathology', 'immunohistochemistry'] },
  { type: 'Basic', front: 'What is the characteristic histological finding in Papillary Thyroid Carcinoma?', back: '• <strong>Orphan Annie eye nuclei</strong> (ground-glass empty-appearing nuclei)<br>• <strong>Nuclear pseudo-inclusions and grooves</strong> ("coffee bean" nuclei)<br>• <strong>Psammoma bodies</strong> (concentric lamellated calcifications).', deck: 'AutoAnki::NEET_PG_Vault::Pathology', subject: 'Pathology', tags: ['endocrine-pathology', 'histology'] },

  // Microbiology
  { type: 'Basic', front: 'Interpret the Serological Markers of Hepatitis B Virus Infection:', back: '<ul><li><strong>HBsAg (+):</strong> Active infection (acute or chronic if > 6 months)</li><li><strong>Anti-HBs (+):</strong> Immunity (via vaccination if isolated, or recovery if Anti-HBc IgG also +)</li><li><strong>Anti-HBc IgM (+):</strong> Acute / recent infection (sole marker in "Window Period")</li><li><strong>HBeAg (+):</strong> High viral replication, high infectivity</li><li><strong>Anti-HBe (+):</strong> Low viral replication, low infectivity</li></ul>', deck: 'AutoAnki::NEET_PG_Vault::Microbiology', subject: 'Microbiology', tags: ['virology', 'serology-pearl', 'hepatology'] },
  { type: 'Cloze', text: 'The causative organism of Syphilis is {{c1::Treponema pallidum}} (spirochete), best visualized using {{c2::Dark-field microscopy}} in primary chancre. Screening is done with {{c3::VDRL / RPR}} and confirmed via {{c4::FTA-ABS / TPHA}}.', deck: 'AutoAnki::NEET_PG_Vault::Microbiology', subject: 'Microbiology', tags: ['bacteriology', 'std', 'diagnostics'] },
  { type: 'Cloze', text: '{{c1::Streptococcus pneumoniae}} is catalase negative, alpha-hemolytic, {{c2::optochin sensitive}}, and {{c3::bile soluble}}, with a polysaccharide capsule producing a positive Neufeld Quellung reaction.', deck: 'AutoAnki::NEET_PG_Vault::Microbiology', subject: 'Microbiology', tags: ['bacteriology', 'gram-positive'] },

  // Forensic Medicine
  { type: 'Cloze', text: '{{c1::Chipping (powder tattooing)}} around a firearm entry wound occurs in {{c2::close range (up to 1-2 feet)}} firing, caused by unburnt gunpowder particles embedded into the dermis.', deck: 'AutoAnki::NEET_PG_Vault::Forensic Medicine', subject: 'Forensic Medicine', tags: ['ballistics', 'trauma-forensics'] },
  { type: 'Basic', front: 'What is Casper Dictum regarding the rate of postmortem putrefaction?', back: 'Rate of putrefaction: <strong>1 week in Air = 2 weeks in Water = 8 weeks in Earth (Buried)</strong> (Ratio 1 : 2 : 8).', deck: 'AutoAnki::NEET_PG_Vault::Forensic Medicine', subject: 'Forensic Medicine', tags: ['thanatology', 'forensic-pearls'] },

  // SPM / Community Medicine
  { type: 'Cloze', text: 'The epidemiological study design that is best suited for rare diseases is the {{c1::Case-Control study}} (measure of association: {{c2::Odds Ratio}}), whereas the {{c3::Cohort study}} is best for rare exposures (measure: {{c4::Relative Risk}}).', deck: 'AutoAnki::NEET_PG_Vault::Social and Preventive Medicine', subject: 'Social and Preventive Medicine', tags: ['epidemiology', 'study-designs', 'biostatistics'] },
  { type: 'Basic', front: 'Define Sensitivity, Specificity, Positive Predictive Value (PPV) and Negative Predictive Value (NPV):', back: '• <strong>Sensitivity:</strong> TP / (TP + FN) — true positive rate, rules OUT disease (SnOUT)<br>• <strong>Specificity:</strong> TN / (TN + FP) — true negative rate, rules IN disease (SpIN)<br>• <strong>PPV:</strong> TP / (TP + FP) — directly proportional to disease prevalence<br>• <strong>NPV:</strong> TN / (TN + FN) — inversely proportional to disease prevalence.', deck: 'AutoAnki::NEET_PG_Vault::Social and Preventive Medicine', subject: 'Social and Preventive Medicine', tags: ['biostatistics', 'screening'] },

  // ENT
  { type: 'Basic', front: 'Differentiate Rinne and Weber Tuning Fork Tests in Conductive vs Sensorineural Hearing Loss:', back: '<ul><li><strong>Rinne Test (512 Hz):</strong><br>• Normal / SNHL: Air Conduction > Bone Conduction (Positive)<br>• Conductive Hearing Loss: Bone Conduction > Air Conduction (Negative)</li><li><strong>Weber Test:</strong><br>• Conductive Loss: Lateralizes to the <em>affected (bad) ear</em><br>• Sensorineural Loss: Lateralizes to the <em>unaffected (normal/better) ear</em></li></ul>', deck: 'AutoAnki::NEET_PG_Vault::ENT', subject: 'ENT', tags: ['audiology', 'clinical-skills', 'exam-favorite'] },
  { type: 'Cloze', text: 'Meniere disease is caused by {{c1::endolymphatic hydrops}} and is characterized by the classic tetrad of: {{c2::episodic rotational vertigo}}, {{c3::fluctuating low-frequency sensorineural hearing loss}}, {{c4::tinnitus}}, and {{c5::aural fullness}}.', deck: 'AutoAnki::NEET_PG_Vault::ENT', subject: 'ENT', tags: ['inner-ear', 'vertigo', 'audio-pearl'] },
  { type: 'Basic', front: 'What is Trotter Triad in Nasopharyngeal Carcinoma?', back: '1. Conductive deafness (due to Eustachian tube obstruction)<br>2. Ipsilateral facial pain / numbness (involving CN V3)<br>3. Palatal paralysis (involving CN X)', deck: 'AutoAnki::NEET_PG_Vault::ENT', subject: 'ENT', tags: ['head-neck', 'triads', 'oncology'] },

  // Ophthalmology
  { type: 'Cloze', text: 'In Acute Angle-Closure Glaucoma, the definitive surgical treatment of choice is {{c1::Laser Peripheral Iridotomy (LPI)}} in both the affected and fellow prophylactic eye.', deck: 'AutoAnki::NEET_PG_Vault::Ophthalmology', subject: 'Ophthalmology', tags: ['glaucoma', 'surgical-pearl', 'emergency'] },
  { type: 'Basic', front: 'What are the classic fundus findings of Central Retinal Artery Occlusion (CRAO)?', back: '• <strong>Cherry-red spot</strong> at the fovea (due to choroidal circulation shining through thin foveal retina)<br>• Diffuse retinal pallor / milky white edema<br>• Boxcarring (cattle-trucking) of retinal vessels<br>• Sudden, painless, severe monocular vision loss.', deck: 'AutoAnki::NEET_PG_Vault::Ophthalmology', subject: 'Ophthalmology', tags: ['retina', 'fundoscopy', 'emergency'] },

  // General Medicine
  { type: 'Cloze', text: 'In ST-Elevation Myocardial Infarction (STEMI), ST elevations in leads V1-V4 indicate an {{c1::Anterior wall}} infarction supplied by the {{c2::Left Anterior Descending (LAD)}} artery.', deck: 'AutoAnki::NEET_PG_Vault::General Medicine', subject: 'General Medicine', tags: ['cardiology', 'ecg', 'coronary-anatomy'] },
  { type: 'Basic', front: 'What is the diagnostic criteria and treatment of choice for Diabetic Ketoacidosis (DKA)?', back: '<strong>Triad:</strong> Hyperglycemia (> 250 mg/dL), High Anion Gap Metabolic Acidosis (pH < 7.3, HCO3 < 18), Ketonemia / Ketonuria.<br><strong>Management:</strong><br>1. IV 0.9% Normal Saline hydration (most crucial initial step)<br>2. Regular IV Insulin infusion (0.1 U/kg/hr) — check Potassium FIRST (do not start if K+ < 3.3)<br>3. Potassium replacement to prevent hypokalemia.', deck: 'AutoAnki::NEET_PG_Vault::General Medicine', subject: 'General Medicine', tags: ['endocrinology', 'emergency', 'guidelines'] },

  // General Surgery
  { type: 'Cloze', text: 'In trauma evaluation, the FAST exam (Focused Assessment with Sonography for Trauma) evaluates 4 acoustic windows: {{c1::Morison pouch (hepatorenal)}}, {{c2::splenorenal recess}}, {{c3::suprapubic (pouch of Douglas)}}, and {{c4::subxiphoid pericardial window}}.', deck: 'AutoAnki::NEET_PG_Vault::General Surgery', subject: 'General Surgery', tags: ['trauma', 'ultrasound', 'atls'] },
  { type: 'Basic', front: 'What is the most common cause of early vs late Post-Thyroidectomy Hemorrhage?', back: '• <strong>Reactionary Hemorrhage (first 24 hours):</strong> Slipped ligature on superior thyroid artery; causes rapid tracheal compression & airway compromise. Immediate bedside wound reopening is mandatory!<br>• <strong>Secondary Hemorrhage (7-10 days):</strong> Wound infection eroding a vessel.', deck: 'AutoAnki::NEET_PG_Vault::General Surgery', subject: 'General Surgery', tags: ['endocrine-surgery', 'complications'] },

  // OBG
  { type: 'Cloze', text: 'The drug of choice for the prevention and treatment of seizures in severe preeclampsia and eclampsia is {{c1::Magnesium Sulfate (MgSO4)}} using the {{c2::Pritchard regimen}} (loading + maintenance). Toxicity is monitored via {{c3::patellar tendon reflex}}, respiratory rate (> 12/min), and urine output (> 30 mL/hr). Antidote is {{c4::Calcium Gluconate}}.', deck: 'AutoAnki::NEET_PG_Vault::Obstetrics and Gynecology', subject: 'Obstetrics and Gynecology', tags: ['obstetrics', 'eclampsia', 'pharmacology'] },

  // Pediatrics
  { type: 'Basic', front: 'What is the single most common cyanotic congenital heart disease manifesting in the neonatal period vs infancy?', back: '• <strong>Neonatal Period (Day 1-2):</strong> Transposition of Great Arteries (TGA) - "Egg on string" appearance on X-ray.<br>• <strong>After 1 Month / Infancy:</strong> Tetralogy of Fallot (TOF) - "Boot-shaped heart" on X-ray, presenting with cyanotic "tet spells".', deck: 'AutoAnki::NEET_PG_Vault::Pediatrics', subject: 'Pediatrics', tags: ['cardiology', 'neonatology', 'radiology-xray'] },

  // Dermatology
  { type: 'Cloze', text: '{{c1::Auspitz sign}} (pinpoint bleeding upon scraping silvery scales) and {{c2::Koebner phenomenon}} (isomorphic response at sites of trauma) are classic clinical features of {{c3::Psoriasis vulgaris}}.', deck: 'AutoAnki::NEET_PG_Vault::Dermatology', subject: 'Dermatology', tags: ['papulosquamous', 'signs'] },
  { type: 'Basic', front: 'Differentiate Pemphigus Vulgaris vs Bullous Pemphigoid on Direct Immunofluorescence (DIF):', back: '• <strong>Pemphigus Vulgaris:</strong> Antibodies against Desmoglein 3/1; Intraepidermal flaccid bullae, Nikolsky (+); DIF shows <em>intercellular fishnet/lace-like IgG/C3 pattern</em>.<br>• <strong>Bullous Pemphigoid:</strong> Antibodies against Hemidesmosomes (BP180/BP230); Subepidermal tense bullae, Nikolsky (-); DIF shows <em>linear basement membrane IgG/C3 band</em>.', deck: 'AutoAnki::NEET_PG_Vault::Dermatology', subject: 'Dermatology', tags: ['immunodermatology', 'vesiculobullous'] },

  // Psychiatry
  { type: 'Cloze', text: 'The first-line mood stabilizer for classic acute mania and bipolar maintenance is {{c1::Lithium}} (therapeutic range: {{c2::0.6 - 1.2 mEq/L}}). Toxicity requires hemodialysis if levels exceed {{c3::4.0 mEq/L}} or severe neurotoxicity.', deck: 'AutoAnki::NEET_PG_Vault::Psychiatry', subject: 'Psychiatry', tags: ['mood-disorders', 'psychopharmacology'] },

  // Radiology
  { type: 'Basic', front: 'Identify the classic radiographic signs associated with these chest conditions:', back: '• <strong>Hampton Hump:</strong> Wedge-shaped peripheral opacity pointing to hilum -> Pulmonary Embolism / Infarct.<br>• <strong>Westermark Sign:</strong> Focal oligemia distal to occluded vessel -> Pulmonary Embolism.<br>• <strong>Gloved Finger Sign:</strong> Bronchial impaction -> Allergic Bronchopulmonary Aspergillosis (ABPA).<br>• <strong>Continuous Diaphragm Sign:</strong> Pneumomediastinum.', deck: 'AutoAnki::NEET_PG_Vault::Radiology', subject: 'Radiology', tags: ['chest-imaging', 'xray-signs'] },

  // Orthopedics
  { type: 'Cloze', text: 'A fracture of the proximal third of the ulna with dislocation of the radial head is known as {{c1::Monteggia fracture-dislocation}} (nerve injured: {{c2::Posterior Interosseous Nerve / PIN}}), whereas a fracture of distal third of radius with DRUJ dislocation is {{c3::Galeazzi fracture}}.', deck: 'AutoAnki::NEET_PG_Vault::Orthopedics', subject: 'Orthopedics', tags: ['fractures', 'eponyms', 'upper-limb'] }
];
...
const hierarchyPaths = [
  'AutoAnki',
  'AutoAnki::NEET_PG_Vault',
  ...subjectsDefinitions.map(s => `AutoAnki::NEET_PG_Vault::${s.subject}`)
];
...
subjectsDefinitions.forEach(s => {
  ...
  deckCardCounts[`AutoAnki::NEET_PG_Vault::${s.subject}`] = count;
